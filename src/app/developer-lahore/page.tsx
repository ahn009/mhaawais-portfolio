...
export const metadata: Metadata = {
  title: 'Web Developer in Lahore | Muhammad Awais',
  description:
    'Hire a professional web developer in Lahore, Pakistan. Muhammad Awais specializes in Next.js, React, MERN Stack development. Local freelance developer for web projects.',
  keywords: [
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-400">
            Professional web development services based in Lahore, Pakistan. Muhammad Awais delivers high-quality solutions for businesses of all sizes.
          </p>
        </div>
        ...
        <section className="mb-12 grid gap-8 md:grid-cols-2">
          ...
          <div className="p-8 rounded-lg bg-slate-800 border border-slate-700 h-fit">
            ...
            <div className="space-y-3 text-sm">
              ...
              <p><span className="font-bold text-blue-400">Experience:</span> 1.5+ years</p>
