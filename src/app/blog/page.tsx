...
export const metadata: Metadata = {
  title: 'Blog - Muhammad Awais | Full Stack Developer',
  description:
    'Read articles and tutorials about Next.js, React, MERN Stack, and AI integration. Expert insights on web development from Muhammad Awais.',
  keywords: [
    'Next.js tutorials',
    'React blog',
    'MERN Stack',
