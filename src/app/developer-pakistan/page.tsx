...
export const metadata: Metadata = {
  title: 'Web Developer in Pakistan | Muhammad Awais',
  description:
    'Looking for a skilled web developer in Pakistan? Muhammad Awais specializes in Next.js, React, MERN Stack development. Hire Pakistani full stack developer online.',
  keywords: [
  ...
  openGraph: {
    ...
    url: 'https://muhammad-awais-portfolio.vercel.app/developer-pakistan',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://muhammad-awais-portfolio.vercel.app/developer-pakistan',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-400">
            Professional web development services from Muhammad Awais, a full-stack developer based in Pakistan. Specializing in Next.js, React, and MERN Stack development.
          </p>
        </div>
