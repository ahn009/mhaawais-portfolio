...
export const metadata: Metadata = {
  ...
  description:
    "Explore Muhammad Awais's portfolio of web development projects. Next.js, React, Node.js, and AI-powered applications. Production-ready code with proven results.",
  openGraph: {
