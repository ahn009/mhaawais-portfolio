...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Muhammad Awais's journey as a Full Stack Developer & AI Solutions Engineer. 1.5+years of experience building scalable applications with Next.js, MERN Stack, RAG chatbots, and AI agents.",
  openGraph: {
