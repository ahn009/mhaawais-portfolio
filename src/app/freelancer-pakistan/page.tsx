...
export const metadata: Metadata = {
  title: 'Freelance Web Developer in Pakistan | Muhammad Awais',
  description:
    'Hire a freelance web developer from Pakistan. Muhammad Awais offers flexible freelance services for Next.js, React, and MERN Stack projects. Remote work available.',
  keywords: [
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-400">
            Flexible freelance web development services from Muhammad Awais. Available for short-term projects, long-term contracts, and everything in between.
          </p>
        </div>
